...
var MagPend = /** @class */ (function () {
    ...
    MagPend.prototype.trace = function (state, drawTrace) {
        ...
        if (drawTrace) {
            this.gfx.clear();
            this.gfx.lineStyle(10, ModelMagPend.rgb2hex(255, 255, 255), 4);
        }
        var length = 0;
    ...
    MagPend.prototype.putPixel = function (x, y, idx, length, refLength) {
        this.bitmap = this.game.make.bitmapData(200, 200);
        // refLength *= 1.5;
        ...
        //         return;
        //     case 2:
        //         this.bitmap.setPixel(x, y,  baseBri * bri, baseBri * bri, 0);
        //         return;
        //     case 3:
        //         this.bitmap.setPixel(x, y, 0,  baseBri * bri, baseBri * bri);
        //         return;
        //     case 4:
